...
scenarioOut$cores <- subsetScenario$cores
scenarioOut$GBMemory <- subsetScenario$GBMemory
...
print(paste("Expected accuracy: ", theMax$accuracy))
```
...
# time.post <- data.frame(time.post)
# time.post$cores <- subsetScenario$cores
# time.post$GBMemory <- subsetScenario$GBMemory
# time.post$config <- subsetScenario$config
# time.post$TotalRate <- subsetScenario$TotalRate
# 
# time.post$postMeanTime <- rowMeans(time.post[, 1:1000])
# time.post$postMeanTime <- exp(time.post$postMeanTime)
# time.post$postMeanCost <- time.post$postMeanTime * time.post$TotalRate
