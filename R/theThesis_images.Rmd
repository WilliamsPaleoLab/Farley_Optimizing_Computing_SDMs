...
ggplot(timeCostMatrix) + 
  # geom_point(aes(x = time, y = cost)) + 
  geom_errorbar(aes(x = time, ymin = time - timeSD, ymax = time+timeSD)) + 
  geom_errorbarh(aes(x = time, y=cost, xmin = cost - costSD, xmax = cost+costSD)) 
```
