...
names(points) <- c("SiteID", "SiteName", "Latitude", "Longitude", "Age", "pollenPercentage", "bio2", "bio7", "bio8", "bio15", "bio18", "bio19")
print("Doing GBM")
gbm250 <- timeSDM(250, ncore, compMem, nrow(points), 0.5, modelMethod='GBM-BRT')
print("Doing RF")
